          ...
          <FormField label="Prompt" description="무엇을 분석하거나 요약할지 자연어로 지시해주세요.">
            <SpaceBetween size="xs">
              <SpaceBetween direction="horizontal" size="xs">
                <Button onClick={() => setPrompt('당신은 영상 컨텐츠를 제작하는 업무를 맡고 있는 마케팅 담당 부서 직원입니다.\n제공된 영상을 기반으로, 핵심 내용만 추려서 짧은 영상을 만드는 업무를 수행해야 합니다.\n해당 영상의 내용을 요약해주시고, 영상에서 주요 장면들을 timestamp와 함께 답변해주세요.')}>영상 요약</Button>
                <Button onClick={() => setPrompt('저는 큰 주택을 가지고 있는 에어비앤비 호스트입니다.\n숙소를 홍보하는 영상을 만들고 싶은데,\n영상에서 전반적인 숙소가 보이는 영상 부분을 찾아주시고 timestamp을 제공해주세요.')}>숙소 장면</Button>
              </SpaceBetween>
              <Textarea
                value={prompt}
